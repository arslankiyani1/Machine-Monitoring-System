...
namespace MMS.Application.Validators.MachineJob;

public class MachineJobAddDtoValidator : AbstractValidator<MachineJobAddDto>
{
    public MachineJobAddDtoValidator()
    {
        // ✅ Customer Validation
